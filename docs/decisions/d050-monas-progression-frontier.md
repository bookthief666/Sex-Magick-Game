...
6. Test Fold-closed and Fold-open profiles, all three pattern anchors, and both ordinary and Warp Surge modes. Pair composition uses its scheduler-correct 0.5 starting anchor and the conservative pair corridor from D-049.
