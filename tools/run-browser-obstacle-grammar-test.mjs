...
const PORT = Number(process.env.PATTERN_QA_HTTP_PORT || 4176);
const URL = `http://127.0.0.1:${PORT}/tools/obstacle-grammar-browser-test.html`;
...
async function main() {
  ...
  try {
    ...
    assert.match(summary, /PASS obstacle grammar browser integration/);
  } finally {
