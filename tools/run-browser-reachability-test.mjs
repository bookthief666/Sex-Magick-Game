...
const PORT = Number(process.env.REACHABILITY_QA_HTTP_PORT || 4177);
const URL = `http://127.0.0.1:${PORT}/tools/reachability-browser-test.html`;
...
async function main() {
  ...
  try {
    ...
    assert.match(summary, /PASS reachability browser integration/);
  } finally {
